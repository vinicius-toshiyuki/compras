...
class ShoppingList extends MapBase<String, Product> {
  ...
  Iterable<String> get keys {
    List<String> pkeys = _products.keys.toList()
      ..sort((key1, key2) {
        if (_products[key1].order == null || _products[key2].order == null)
          return -1;
  ...
  void operator []=(String key, Product val) {
    _update();
    _products[key] = val;
  }

  set products(Map<String, Product> val) {
    _update();
    products = val;
  }
